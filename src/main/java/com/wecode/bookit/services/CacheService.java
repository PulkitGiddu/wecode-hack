...
/**
 * Cache Service for static and semi-static data
 *
 * Priority 1: Amenities & Seating Capacity (cached permanently)
 * Priority 2: Meeting Rooms (cached with 10-minute TTL)
 */
@Service
